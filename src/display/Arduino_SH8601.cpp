...
Arduino_SH8601::Arduino_SH8601(Arduino_DataBus *bus, int8_t rst, uint8_t r,
                               bool ips, int16_t w, int16_t h)
    : Arduino_TFT(bus, rst, r, ips, w, h, 0, 0, 0, 0) {}

bool Arduino_SH8601::begin(int32_t speed) { return Arduino_TFT::begin(speed); }

void Arduino_SH8601::writeAddrWindow(int16_t x, int16_t y, uint16_t w,
                                     uint16_t h) {
...
void Arduino_SH8601::setRotation(uint8_t r) {
  ...
  case 0:
    r = SH8601_MADCTL_COLOR_ORDER |
        SH8601_MADCTL_Y_AXIS_FLIP; // Flip left and right
  case 1:
