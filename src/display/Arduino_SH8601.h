...
#define SH8601_W_WDBRIGHTNESSVALAOD                                            \
  0x4A // Write Display Brightness Value in AOD Mode
#define SH8601_R_RDBRIGHTNESSVALAOD                                            \
  0x4B                           // Read Display Brightness Value in AOD Mode
#define SH8601_W_DEEPSTMODE 0x4F // Deep Standby Mode On

#define SH8601_W_WDBRIGHTNESSVALNOR                                            \
  0x51 // Write Display Brightness Value in Normal Mode
#define SH8601_R_RDBRIGHTNESSVALNOR                                            \
  0x52                        // Read display brightness value in Normal Mode
...
#define SH8601_W_WDBRIGHTNESSVALHBM                                            \
  0x63 // Write Display Brightness Value in HBM Mode
#define SH8601_R_WDBRIGHTNESSVALHBM                                            \
  0x64                        // Read Display Brightness Value in HBM Mode
...
static const uint8_t sh8601_init_operations[] = {
    ...
    WRITE_C8_D8, SH8601_W_WCTRLD1,
    0x28, // Brightness Control On and Display Dimming On
...
public:
  Arduino_SH8601(Arduino_DataBus *bus, int8_t rst = GFX_NOT_DEFINED,
                 uint8_t r = 0, bool ips = false, int16_t w = SH8601_MAXWIDTH,
                 int16_t h = SH8601_MAXHEIGHT);
